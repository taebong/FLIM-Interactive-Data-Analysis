...
function varargout = FLIMDataAnalysisGUI_ver7_5(varargin)
% FLIMDATAANALYSISGUI_VER7_5 MATLAB code for FLIMDataAnalysisGUI_ver7_5.fig
%      FLIMDATAANALYSISGUI_VER7_5, by itself, creates a new FLIMDATAANALYSISGUI_VER7_5 or raises the existing
%      singleton*.
%d
%      H = FLIMDATAANALYSISGUI_VER7_5 returns the handle to a new FLIMDATAANALYSISGUI_VER7_5 or the handle to
%      the existing singleton*.
%
%      FLIMDATAANALYSISGUI_VER7_5('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in FLIMDATAANALYSISGUI_VER7_5.M with the given input arguments.
%
%      FLIMDATAANALYSISGUI_VER7_5('Property','Value',...) creates a new FLIMDATAANALYSISGUI_VER7_5 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before FLIMDataAnalysisGUI_ver7_5_OpeningFcn gets called.  An
...
% Edit the above text to modify the response to help FLIMDataAnalysisGUI_ver7_5

% Last Modified by GUIDE v2.5 08-Jul-2015 10:58:40

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @FLIMDataAnalysisGUI_ver7_5_OpeningFcn, ...
    'gui_OutputFcn',  @FLIMDataAnalysisGUI_ver7_5_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before FLIMDataAnalysisGUI_ver7_5 is made visible.
function FLIMDataAnalysisGUI_ver7_5_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to FLIMDataAnalysisGUI_ver7_5 (see VARARGIN)

% Choose default command line output for FLIMDataAnalysisGUI_ver7_5
...
% so window can get raised using FLIMDataAnalysisGUI_ver7_5.
if strcmp(get(hObject,'Visible'),'off')
    
end

% UIWAIT makes FLIMDataAnalysisGUI_ver7_5 wait for user response (see UIRESUME)
% uiwait(handles.MainGui);


% --- Outputs from this function are returned to the command line.
function varargout = FLIMDataAnalysisGUI_ver7_5_OutputFcn(hObject, eventdata, handles)
