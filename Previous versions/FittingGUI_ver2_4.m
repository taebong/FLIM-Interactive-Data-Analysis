function varargout = FittingGUI_ver2_4(varargin)
% FITTINGGUI_VER2_4 MATLAB code for FittingGUI_ver2_4.fig
%      FITTINGGUI_VER2_4, by itself, creates a new FITTINGGUI_VER2_4 or raises the existing
%      singleton*.
%
%      H = FITTINGGUI_VER2_4 returns the handle to a new FITTINGGUI_VER2_4 or the handle to
%      the existing singleton*.
%
%      FITTINGGUI_VER2_4('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in FITTINGGUI_VER2_4.M with the given input arguments.
%
%      FITTINGGUI_VER2_4('Property','Value',...) creates a new FITTINGGUI_VER2_4 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before FittingGUI_ver2_4_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to FittingGUI_ver2_4_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help FittingGUI_ver2_4

% Last Modified by GUIDE v2.5 16-Jun-2013 17:12:56

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @FittingGUI_ver2_4_OpeningFcn, ...
    'gui_OutputFcn',  @FittingGUI_ver2_4_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before FittingGUI_ver2_4 is made visible.
function FittingGUI_ver2_4_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to FittingGUI_ver2_4 (see VARARGIN)

% Choose default command line output for FittingGUI_ver2_4
...
% UIWAIT makes FittingGUI_ver2_4 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = FittingGUI_ver2_4_OutputFcn(hObject, eventdata, handles)
...
elseif fitting_method == 3
    for j = selected
        ...
        tic;
        [p_fit,sigma_p,p,post] = bayes_fit(@bayes_decay_model,time,decay,dp,p_min,p_max,nexpo,1,fit_start,fit_end);
        toc;
