...
function varargout = FLIMDataAnalysisGUI_ver7_4(varargin)
% FLIMDATAANALYSISGUI_VER7_4 MATLAB code for FLIMDataAnalysisGUI_ver7_4.fig
%      FLIMDATAANALYSISGUI_VER7_4, by itself, creates a new FLIMDATAANALYSISGUI_VER7_4 or raises the existing
%      singleton*.
%d
%      H = FLIMDATAANALYSISGUI_VER7_4 returns the handle to a new FLIMDATAANALYSISGUI_VER7_4 or the handle to
%      the existing singleton*.
%
%      FLIMDATAANALYSISGUI_VER7_4('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in FLIMDATAANALYSISGUI_VER7_4.M with the given input arguments.
%
%      FLIMDATAANALYSISGUI_VER7_4('Property','Value',...) creates a new FLIMDATAANALYSISGUI_VER7_4 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before FLIMDataAnalysisGUI_ver7_4_OpeningFcn gets called.  An
...
% Edit the above text to modify the response to help FLIMDataAnalysisGUI_ver7_4

% Last Modified by GUIDE v2.5 02-Jul-2015 10:57:58

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @FLIMDataAnalysisGUI_ver7_4_OpeningFcn, ...
    'gui_OutputFcn',  @FLIMDataAnalysisGUI_ver7_4_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before FLIMDataAnalysisGUI_ver7_4 is made visible.
function FLIMDataAnalysisGUI_ver7_4_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to FLIMDataAnalysisGUI_ver7_4 (see VARARGIN)

% Choose default command line output for FLIMDataAnalysisGUI_ver7_4
...
% so window can get raised using FLIMDataAnalysisGUI_ver7_4.
if strcmp(get(hObject,'Visible'),'off')
    
end

% UIWAIT makes FLIMDataAnalysisGUI_ver7_4 wait for user response (see UIRESUME)
% uiwait(handles.MainGui);


% --- Outputs from this function are returned to the command line.
function varargout = FLIMDataAnalysisGUI_ver7_4_OutputFcn(hObject, eventdata, handles)
...
%update total number of selected pixel
set(handles.NumOfSelectedPixel_text,'String',num2str(sum(sum(image_struct{sliderval}.selected_pixel(x_min:x_max,y_min:y_max)))))
