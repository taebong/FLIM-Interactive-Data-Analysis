function varargout = ImportImagesGUI_v02(varargin)
% IMPORTIMAGESGUI_V02 MATLAB code for ImportImagesGUI_v02.fig
%      IMPORTIMAGESGUI_V02 by itself, creates a new IMPORTIMAGESGUI_V02 or raises the
%      existing singleton*.
%
%      H = IMPORTIMAGESGUI_V02 returns the handle to a new IMPORTIMAGESGUI_V02 or the handle to
%      the existing singleton*.
%
%      IMPORTIMAGESGUI_V02('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in IMPORTIMAGESGUI_V02.M with the given input arguments.
%
%      IMPORTIMAGESGUI_V02('Property','Value',...) creates a new IMPORTIMAGESGUI_V02 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ImportImagesGUI_v02_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ImportImagesGUI_v02_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ImportImagesGUI_v02

% Last Modified by GUIDE v2.5 08-Jul-2015 10:59:10

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @ImportImagesGUI_v02_OpeningFcn, ...
    'gui_OutputFcn',  @ImportImagesGUI_v02_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before ImportImagesGUI_v02 is made visible.
function ImportImagesGUI_v02_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ImportImagesGUI_v02 (see VARARGIN)
...
% UIWAIT makes ImportImagesGUI_v02 wait for user response (see UIRESUME)
%uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = ImportImagesGUI_v02_OutputFcn(hObject, eventdata, handles)
