function [avg_p,sigma_p,p_vec,post,marg_post,mle] = bayes_fit(time,data,dp,p_min,p_max,nexpo,prior,fit_start,fit_end,alpha,parallel)
...
lik_vec = calclikelihood(time,data,time_irf,irf,pmat,nexpo,fit_start,fit_end,parallel);
