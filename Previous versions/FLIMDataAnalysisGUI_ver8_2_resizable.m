...
function varargout = FLIMDataAnalysisGUI_ver8_2_resizable(varargin)
% FLIMDATAANALYSISGUI_VER8_2_RESIZABLE MATLAB code for FLIMDataAnalysisGUI_ver8_2_resizable.fig
%      FLIMDATAANALYSISGUI_VER8_2_RESIZABLE, by itself, creates a new FLIMDATAANALYSISGUI_VER8_2_RESIZABLE or raises the existing
%      singleton*.
%
%      H = FLIMDATAANALYSISGUI_VER8_2_RESIZABLE returns the handle to a new FLIMDATAANALYSISGUI_VER8_2_RESIZABLE or the handle to
%      the existing singleton*.6
%   
%      FLIMDATAANALYSISGUI_VER8_2_RESIZABLE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in FLIMDATAANALYSISGUI_VER8_2_RESIZABLE.M with the given input ar5guments.
%
%      FLIMDATAANALYSISGUI_VER8_2_RESIZABLE('Property','Value',...) creates a new FLIMDATAANALYSISGUI_VER8_2_RESIZABLE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before FLIMDataAnalysisGUI_ver8_2_resizable_OpeningFcn gets called.  An
...
% Edit the above text to modify the response to help FLIMDataAnalysisGUI_ver8_2_resizable

% Last Modified by GUIDE v2.5 19-Mar-2017 17:56:14

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @FLIMDataAnalysisGUI_ver8_2_resizable_OpeningFcn, ...
    'gui_OutputFcn',  @FLIMDataAnalysisGUI_ver8_2_resizable_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before FLIMDataAnalysisGUI_ver8_2_resizable is made visible.
function FLIMDataAnalysisGUI_ver8_2_resizable_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to FLIMDataAnalysisGUI_ver8_2_resizable (see VARARGIN)

% Choose default command line output for FLIMDataAnalysisGUI_ver8_2_resizable
...
% so window can get raised using FLIMDataAnalysisGUI_ver8_2_resizable.
if strcmp(get(hObject,'Visible'),'off')
    
end

% UIWAIT makes FLIMDataAnalysisGUI_ver8_2_resizable wait for user response (see UIRESUME)
% uiwait(handles.MainGui);


% --- Outputs from this function are returned to the command line.
function varargout = FLIMDataAnalysisGUI_ver8_2_resizable_OutputFcn(hObject, eventdata, handles)
...
figname = 'KinetochoreSelectionTool_ver8_1';
