function varargout = FittingGUI_ver3_4(varargin)
% FITTINGGUI_VER3_4 MATLAB code for FittingGUI_ver3_4.fig
%      FITTINGGUI_VER3_4, by itself, creates a new FITTINGGUI_VER3_4 or raises the existing
%      singleton*.
%
%      H = FITTINGGUI_VER3_4 returns the handle to a new FITTINGGUI_VER3_4 or the handle to
%      the existing singleton*.
%
%      FITTINGGUI_VER3_4('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in FITTINGGUI_VER3_4.M with the given input arguments.
%
%      FITTINGGUI_VER3_4('Property','Value',...) creates a new FITTINGGUI_VER3_4 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before FittingGUI_ver3_4_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to FittingGUI_ver3_4_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help FittingGUI_ver3_4

% Last Modified by GUIDE v2.5 15-Oct-2013 18:03:02

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @FittingGUI_ver3_4_OpeningFcn, ...
    'gui_OutputFcn',  @FittingGUI_ver3_4_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before FittingGUI_ver3_4 is made visible.
function FittingGUI_ver3_4_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to FittingGUI_ver3_4 (see VARARGIN)

% Choose default command line output for FittingGUI_ver3_4
...
% UIWAIT makes FittingGUI_ver3_4 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = FittingGUI_ver3_4_OutputFcn(hObject, eventdata, handles)
...
set(handles.TotalCount_text,'String',total_count);
...
for i = 1:NumNewDecays
    ...
    if isfield(new_decay_struct{i},'fitting_method')==0 | ...
        ...
        new_decay_struct{i}.fit_result = zeros(5,3);
