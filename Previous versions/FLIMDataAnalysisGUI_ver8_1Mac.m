...
function varargout = FLIMDataAnalysisGUI_ver8_1Mac(varargin)
% FLIMDATAANALYSISGUI_VER8_1MAC MATLAB code for FLIMDataAnalysisGUI_ver8_1Mac.fig
%      FLIMDATAANALYSISGUI_VER8_1MAC, by itself, creates a new FLIMDATAANALYSISGUI_VER8_1MAC or raises the existing
%      singleton*.
%
%      H = FLIMDATAANALYSISGUI_VER8_1MAC returns the handle to a new FLIMDATAANALYSISGUI_VER8_1MAC or the handle to
%      the existing singleton*.
%
%      FLIMDATAANALYSISGUI_VER8_1MAC('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in FLIMDATAANALYSISGUI_VER8_1MAC.M with the given input arguments.
%
%      FLIMDATAANALYSISGUI_VER8_1MAC('Property','Value',...) creates a new FLIMDATAANALYSISGUI_VER8_1MAC or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before FLIMDataAnalysisGUI_ver8_1Mac_OpeningFcn gets called.  An
...
% Edit the above text to modify the response to help FLIMDataAnalysisGUI_ver8_1Mac

% Last Modified by GUIDE v2.5 31-Dec-2015 18:02:24

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @FLIMDataAnalysisGUI_ver8_1Mac_OpeningFcn, ...
    'gui_OutputFcn',  @FLIMDataAnalysisGUI_ver8_1Mac_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before FLIMDataAnalysisGUI_ver8_1Mac is made visible.
function FLIMDataAnalysisGUI_ver8_1Mac_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to FLIMDataAnalysisGUI_ver8_1Mac (see VARARGIN)

% Choose default command line output for FLIMDataAnalysisGUI_ver8_1Mac
...
% so window can get raised using FLIMDataAnalysisGUI_ver8_1Mac.
if strcmp(get(hObject,'Visible'),'off')
    
end

% UIWAIT makes FLIMDataAnalysisGUI_ver8_1Mac wait for user response (see UIRESUME)
% uiwait(handles.MainGui);


% --- Outputs from this function are returned to the command line.
function varargout = FLIMDataAnalysisGUI_ver8_1Mac_OutputFcn(hObject, eventdata, handles)
...
figname = 'KinetochoreSelectionTool_ver7_3';
