...
function varargout = FLIMDataAnalysisGUI_ver8_1(varargin)
% FLIMDATAANALYSISGUI_VER8_1 MATLAB code for FLIMDataAnalysisGUI_ver8_1.fig
%      FLIMDATAANALYSISGUI_VER8_1, by itself, creates a new FLIMDATAANALYSISGUI_VER8_1 or raises the existing
%      singleton*.
%
%      H = FLIMDATAANALYSISGUI_VER8_1 returns the handle to a new FLIMDATAANALYSISGUI_VER8_1 or the handle to
%      the existing singleton*.6
%
%      FLIMDATAANALYSISGUI_VER8_1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in FLIMDATAANALYSISGUI_VER8_1.M with the given input ar5guments.
%
%      FLIMDATAANALYSISGUI_VER8_1('Property','Value',...) creates a new FLIMDATAANALYSISGUI_VER8_1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before FLIMDataAnalysisGUI_ver8_1_OpeningFcn gets called.  An
...
% Edit the above text to modify the response to help FLIMDataAnalysisGUI_ver8_1

% Last Modified by GUIDE v2.5 08-Sep-2016 16:31:38

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @FLIMDataAnalysisGUI_ver8_1_OpeningFcn, ...
    'gui_OutputFcn',  @FLIMDataAnalysisGUI_ver8_1_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before FLIMDataAnalysisGUI_ver8_1 is made visible.
function FLIMDataAnalysisGUI_ver8_1_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to FLIMDataAnalysisGUI_ver8_1 (see VARARGIN)

% Choose default command line output for FLIMDataAnalysisGUI_ver8_1
...
% so window can get raised using FLIMDataAnalysisGUI_ver8_1.
if strcmp(get(hObject,'Visible'),'off')
    
end

% UIWAIT makes FLIMDataAnalysisGUI_ver8_1 wait for user response (see UIRESUME)
% uiwait(handles.MainGui);


% --- Outputs from this function are returned to the command line.
function varargout = FLIMDataAnalysisGUI_ver8_1_OutputFcn(hObject, eventdata, handles)
...
[binned_flim,W] = ndnanfilter(image_struct{selected(1)}.flim,@rectwin,[0,binning,binning]);
