function varargout = KinetochoreSelectionTool_ver7_3(varargin)
% KINETOCHORESELECTIONTOOL_VER7_3 MATLAB code for KinetochoreSelectionTool_ver7_3.fig
%      KINETOCHORESELECTIONTOOL_VER7_3, by itself, creates a new KINETOCHORESELECTIONTOOL_VER7_3 or raises the existing
%      singleton*.
%
%      H = KINETOCHORESELECTIONTOOL_VER7_3 returns the handle to a new KINETOCHORESELECTIONTOOL_VER7_3 or the handle to
%      the existing singleton*.
%
%      KINETOCHORESELECTIONTOOL_VER7_3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in KINETOCHORESELECTIONTOOL_VER7_3.M with the given input arguments.
%
%      KINETOCHORESELECTIONTOOL_VER7_3('Property','Value',...) creates a new KINETOCHORESELECTIONTOOL_VER7_3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before KinetochoreSelectionTool_ver7_3_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to KinetochoreSelectionTool_ver7_3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help KinetochoreSelectionTool_ver7_3
% Last Modified by GUIDE v2.5 23-Aug-2015 19:11:58

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @KinetochoreSelectionTool_ver7_3_OpeningFcn, ...
    'gui_OutputFcn',  @KinetochoreSelectionTool_ver7_3_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
function varargout = KinetochoreSelectionTool_ver7_3_OutputFcn(hObject, eventdata, handles)
...
% --- Executes just before KinetochoreSelectionTool_ver7_3 is made visible.
function KinetochoreSelectionTool_ver7_3_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to KinetochoreSelectionTool_ver7_3 (see VARARGIN)

% Choose default command line output for KinetochoreSelectionTool_ver7_3
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes KinetochoreSelectionTool_ver7_3 wait for user response (see UIRESUME)
