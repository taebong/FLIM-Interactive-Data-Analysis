function save_fit_result(pathname, decay_struct, plotbool)
...
if plotbool == 1
    ...
    if fitting_method == 2
        ...
        psampled = decay_struct.fit_detail.post;
        for i = 1:N_param
            subplot(N_param,1,i)
    ...
    elseif fitting_method == 3
        h(3) = figure;
        p_vec = decay_struct.fit_detail.p_vec;
        marg_post = decay_struct.fit_detail.marg_post;
