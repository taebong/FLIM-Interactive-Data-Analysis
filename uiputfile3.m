function [filename, pathname, filterindex] = uiputfile3(varargin)
...
putfileInput = varargin;
putfileInput(indMode:indMode+1) = [];
% call uigetfile with arguments passed from uigetfile2 function
[filename, pathname, filterindex] = uiputfile(putfileInput{:});
